...
export const Sidebar = () => {
  return (
    <aside className="sidebar fixed z-10 top-16 bottom-0 text-xs text-blue-900 h-screen right-0 p-2 w-[90px] overflow-auto text-center bg-gray-200 shadow">
