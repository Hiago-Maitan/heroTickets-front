...
export const CardFilter = () => {
  return (
    <div className="rounded mt-4 mb-6">
      <div className="w-full p-3 h-[150px] relative bg-black bg-opacity-25 rounded-b-none rounded-3xl shadow">
      ...
      <div className="w-full p-3 relative bg-slate-200 bg-opacity-25 border border-b-blue-950 border-x-blue-950 rounded-t-none rounded-3xl shadow">
